...
const imagemBotatoTrocaDeTema = document.querySelector(".imagem-botao");
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    if (modoEscuroEstaAtivo) {
        imagemBotatoTrocaDeTema.setAttribute("src", "./src/imagens/sun.png")
    } else {
        imagemBotatoTrocaDeTema.setAttribute("src", "./src/imagens/moon.png")
    }
